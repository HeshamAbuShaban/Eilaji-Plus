package dev.training.eilaji_plus.ui.fragments.vms
    ...
    fun getUserLastLocation() {
        if (arePermissionsGranted()) {
            ...
            if (location != null) {
                ...
                Log.i(
                    "MVM",
                    "updateLastLocation: location: $location, lat: $latitude, lng: $longitude"
                )
                ...
                fusedLocationClient.lastLocation.addOnSuccessListener { fusedLocationClientLocation ->
                    fusedLocationClientLocation?.let {
                        ...
                        Log.i(
                            "MVM",
                            "FusedUpdateLastLocation: location: $it, lat: ${it.latitude}, lng: ${it.longitude}"
                        )
                    }
